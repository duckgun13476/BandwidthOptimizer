...
public final class BandwidthOptimizerHudStats {
    ...
    public static Snapshot snapshot() {
        ...
        return new Snapshot(
                ...
                serverSnapshot.serverChunkReuseLogicalBytes(),
                ...
                serverSnapshot.serverSourceGateEstimatedSavedBytes(),
                serverSnapshot.serverSourceGateEstimatedOutboundSavedBytes(),
                serverSnapshot.serverSourceGateSuppressedFrames(),
                serverSnapshot.serverRecipeLogicalBytes(),
                serverSnapshot.serverRecipeFrameBytes(),
                serverSnapshot.serverRecipeSavedBytes(),
                serverSnapshot.serverRecipeFullFrames(),
                serverSnapshot.serverRecipeIdentityFrames(),
                serverSnapshot.serverRecipeStructuralDeltaFrames(),
                serverSnapshot.serverRecipeByteDeltaFrames(),
