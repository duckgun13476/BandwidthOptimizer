...
public enum ClientReconnectPlatform implements ClientReconnectCoordinator.Platform {
    ...
    public boolean startConnection(ClientReconnectCoordinator.Target target) {
        ...
        ServerData serverData = new ServerData(target.name(), target.address(), false);
        try {
            ConnectScreen.class
                    .getMethod("startConnecting", Screen.class, Minecraft.class, ServerAddress.class, ServerData.class, boolean.class)
                    .invoke(null, parent, minecraft, address, serverData, false);
            return true;
        ...
        try {
            ConnectScreen.class
                    ...
                    .invoke(null, parent, minecraft, address, serverData);
            return true;
