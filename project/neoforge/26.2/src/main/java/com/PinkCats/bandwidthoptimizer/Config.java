...
public class Config {
    ...
    public static final ModConfigSpec.BooleanValue ENABLE_OPTIMIZER_STATS_LOGS;
    ...
    public static final ModConfigSpec.BooleanValue ENABLE_BATCH_SHA256_DICTIONARY;
    public static final ModConfigSpec.BooleanValue ENABLE_BATCH_TEMPLATE_DICTIONARY;
    public static final ModConfigSpec.BooleanValue ENABLE_BATCH_ZSTD;
    public static final ModConfigSpec.BooleanValue ENABLE_BATCH_STREAMING_ZSTD;
    public static final ModConfigSpec.BooleanValue ENABLE_ASYNC_PLAY_BATCH_ENCODING;
    public static final ModConfigSpec.BooleanValue ENABLE_PERSISTENT_RECIPE_DELTA;

    public static final ModConfigSpec.IntValue BATCH_ZSTD_LEVEL;
    public static final ModConfigSpec.IntValue BATCH_STREAMING_ZSTD_LEVEL;

    public static final ModConfigSpec.IntValue BATCH_TEMPLATE_DICTIONARY_MAX_PACKET_BYTES;
    public static final ModConfigSpec.IntValue BATCH_TEMPLATE_DICTIONARY_MAX_ENTRIES;
    public static final ModConfigSpec.IntValue BATCH_TEMPLATE_DICTIONARY_MAX_PAYLOAD_BYTES;
    public static final ModConfigSpec.IntValue BATCH_TEMPLATE_DICTIONARY_MAX_DIFF_RUNS;
    public static final ModConfigSpec.IntValue BATCH_TEMPLATE_DICTIONARY_MAX_CHANGED_BYTES;

    public static final ModConfigSpec.IntValue BATCH_SHA256_DICTIONARY_MAX_PACKET_BYTES;
    public static final ModConfigSpec.IntValue BATCH_SHA256_DICTIONARY_MAX_ENTRIES;
    public static final ModConfigSpec.IntValue BATCH_SHA256_DICTIONARY_MAX_PAYLOAD_BYTES;
    ...
    public static final class RuntimeProperty {
        ...
        public static final class Transport {
            ...
            public static final String COMMAND_TREE_DEDUP_ENABLED = "bandwidthoptimizer.transport.commandTreeDedupEnabled";
