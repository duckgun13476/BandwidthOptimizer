...
public final class ClientPacketHandleDiagnosticProbe {
    ...
    public static void BO_Diag_movementPositionHandle(
        ...
        DiagnosticLog.info(
                ...
                "index={}, packetChange={}, packetId={}, relative={}, playerPos=({}, {}, {}), playerChunk=({}, {})",
                index,
                packet == null ? "<null>" : packet.change(),
                packet == null ? 0 : packet.id(),
                packet == null ? "<null>" : packet.relatives(),
                playerX,
                playerY,
                playerZ,
                playerChunkX,
    ...
    public static void BO_Diag_cacheChunkHandle(String kind, int chunkX, int chunkZ, int radius, boolean cached) {
        ...
        DiagnosticLog.info(
                ...
                index, kind, chunkX, chunkZ, radius, cached
        );
    }
    ...
    private static boolean isEnabled(DiagnosticToolRegistry.Tool tool) {
        ...
        return DiagnosticToolRegistry.isEnabled(tool) || DiagnosticRuntimeSwitch.isEnabled(legacyTopic);
    }
}
