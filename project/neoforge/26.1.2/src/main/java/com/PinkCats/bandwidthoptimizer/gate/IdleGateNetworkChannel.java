...
public final class IdleGateNetworkChannel {
    ...
    static final Identifier CHANNEL_ID =
            Identifier.fromNamespaceAndPath(Bandwidthoptimizer.MODID, Bandwidthoptimizer.versionedNetworkPath("idle_state"));
    ...
    private static void sendToServer(IdleGateStatePayload payload) {
        ClientPacketDistributor.sendToServer(new IdleGateStateBytePayload(
