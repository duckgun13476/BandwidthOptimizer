const translations = {
  'zh-CN': {
    ...
    bypassAnalysis: '旁路流量分析', bypassSubtitle: '自定义通道按模组 ID 精确归属；共享原版协议按用途细分，不代表具体模组来源。', bypassSources: '通道与协议归属', bypassEntries: '包级明细', capturedKeys: '已上传键', distinctKeys: '不同键', cumulativeTraffic: '累计流量', windowTraffic: '当前窗口', unlistedKeys: '未列出的键', sharedProtocol: '共享原版协议', thirdPartyPacket: '第三方包类', protocolControl: '协议控制', familyRecipeRegistry: '配方与注册表', familyEntity: '实体同步', familyWorld: '区块与方块', familyEffects: '声音与特效', familyPlayerUi: '玩家与界面', familyConnection: '连接与配置', familyOther: '其他协议',
  ...
  'en-US': {
    ...
    bypassAnalysis: 'Bypass traffic analysis', bypassSubtitle: 'Custom channels use exact mod IDs. Shared vanilla protocols are grouped by purpose and do not identify the originating mod.', bypassSources: 'Channel and protocol attribution', bypassEntries: 'Packet details', capturedKeys: 'Uploaded keys', distinctKeys: 'Distinct keys', cumulativeTraffic: 'Cumulative traffic', windowTraffic: 'Current window', unlistedKeys: 'Unlisted keys', sharedProtocol: 'Shared vanilla protocol', thirdPartyPacket: 'Third-party packet class', protocolControl: 'Protocol control', familyRecipeRegistry: 'Recipes and registries', familyEntity: 'Entity synchronization', familyWorld: 'Chunks and blocks', familyEffects: 'Sounds and effects', familyPlayerUi: 'Player and UI', familyConnection: 'Connection and configuration', familyOther: 'Other protocol',
  ...
  'pt-BR': {
    ...
    bypassAnalysis: 'Análise do tráfego desviado', bypassSubtitle: 'Canais personalizados usam IDs exatos dos mods. Protocolos vanilla compartilhados são agrupados por finalidade e não identificam o mod de origem.', bypassSources: 'Atribuição de canal e protocolo', bypassEntries: 'Detalhes dos pacotes', capturedKeys: 'Chaves enviadas', distinctKeys: 'Chaves distintas', cumulativeTraffic: 'Tráfego acumulado', windowTraffic: 'Janela atual', unlistedKeys: 'Chaves não listadas', sharedProtocol: 'Protocolo vanilla compartilhado', thirdPartyPacket: 'Classe de pacote de terceiros', protocolControl: 'Controle de protocolo', familyRecipeRegistry: 'Receitas e registros', familyEntity: 'Sincronização de entidades', familyWorld: 'Chunks e blocos', familyEffects: 'Sons e efeitos', familyPlayerUi: 'Jogador e interface', familyConnection: 'Conexão e configuração', familyOther: 'Outro protocolo',
